...
app.config.update(
    ...
    DATABASE=Path(app.instance_path) / 'users_v6.db',
...
def index():
    ...
    return render_template(
        'index_6.html', recent_history=recent_history,
...
def register():
    ...
    if request.method == 'POST':
        ...
        flash(error, 'error')
    return render_template('auth_6.html', mode='register')
...
def login():
    ...
    return render_template('auth_6.html', mode='login')
...
def admin_users():
    ...
    return render_template(
        'admin_6.html', users=users, stats=stats,
